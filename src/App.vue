...
import { Search, Plus, RefreshCw, Box, LayoutGrid, ClipboardList } from 'lucide-vue-next';
        ...
        <main class="max-w-7xl mx-auto bg-gray-50">
            ...
            <div class="flex w-full my-8 items-center border-b border-gray-200">
                <button
                    ...
                    "
                >
                    <LayoutGrid class="w-4 h-4" :class="
                        abaAtiva === 'inventario'
                            ? 'text-red-600'
                            : 'text-gray-500'  
                        " /> 
                ...
                <button
                    ...
                    "
                >
                    <ClipboardList class="w-4 h-4" :class="
                        abaAtiva === 'emprestimos'
                            ? 'text-red-600'
                            : 'text-gray-500'  
                        " 
