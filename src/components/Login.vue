...
<template>
    <div class="min-h-screen flex items-center justify-center bg-gray-100 p-4">
        <div
            class="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden border border-gray-200"
        >
            <div class="bg-red-800 p-8 text-center">
                <div class="w-24 h-24 mx-auto mb-4 white">
                    <img
                        src="../assets/Logo-CBMSE-1.svg"
                        alt="Brasão do Corpo de Bombeiros Militar de Sergipe"
                ...
                <p class="text-red-100 text-sm mt-1">
                    Acesso Restrito ao Plantonista
                </p>
            </div>
            ...
            <form @submit.prevent="handleLogin" class="p-8 space-y-6">
                <div
                    v-if="msgErro"
                    class="bg-red-50 text-red-600 text-sm font-semibold p-3 rounded-lg border border-red-100 flex items-center justify-center"
                >
